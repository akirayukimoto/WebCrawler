...
gethttp: gethttp.cpp openhttp.cpp SimpleHTMLParser.cpp
	g++ -o gethttp -g gethttp.cpp openhttp-old.cpp SimpleHTMLParser2.cpp -lcurl

webcrawler: webcrawler.cpp openhttp.cpp SimpleHTMLParser.cpp gethttp.cpp
	g++ -o webcrawler -g openhttp-old.cpp SimpleHTMLParser2.cpp webcrawler2.cpp HashTableTemplate.h -lcurl
